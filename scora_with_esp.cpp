...
<body>
    ...
    <div id="About">
        <div class="b">
            <h1 id="h1" style="color: yellow;font-weight: bolder;">
                SCORA ER-14 ROBOT
    ...
    <div id="Operation">
        ...
        <div class="f">
            ...
            <div>
                <label>Joint 1:</label>
                <input  type="number" placeholder="Angle in Degrees">                
            </div>
            <div>
                <label>Joint 2:</label>
                <input type="number" placeholder="Angle in Degrees">                
